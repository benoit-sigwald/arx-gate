...
const DESC = {
  ...
  capgrowth:         'CRM multi-mandats : contacts, segments, gabarits, campagnes e-mail et reponses.',
...
const SECURITY = {
  ...
  capgrowth:         { label: 'Compte nominatif',  kind: 'key',     detail: 'Authentification propre (next-auth), mot de passe hache, droits par mandat - hors porte' },
  ...
  try {
    ...
    const FAMILIES = [
      ...
      ['Applications', ['blackstone', 'candidatures', 'prospects', 'gate', 'tracker',
                        'mail-review', 'whatsapp', 'atlas', 'capgrowth']],
